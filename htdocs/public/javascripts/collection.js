...
var cjs = function() {
  ...
  function filterData(href, rel) {
    ...
    if(args==='') {
      window.location = url + "?filter="+encodeURIComponent(href.replace('http:127.0.0.1:8190',''));
    }
    else {
      ...
      url = url + "?filter="+encodeURIComponent(href.replace('http:127.0.0.1:8190','')+'?');
  ...
  function templateLink() {
    ...
    a.appendChild(document.createTextNode('Add Graph'));
    p = document.createElement('p');
