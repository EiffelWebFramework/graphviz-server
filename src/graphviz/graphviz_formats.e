...
feature -- Access
	...
	supported_formats: ARRAY [STRING_8]
		...
		once
			Result := <<"bmp", --Windows Bitmap Format
 "canon", "cmap", --	Client-side imagemap (deprecated)
 "cmapx", --Server-side and client-side imagemaps
 "cmapx_np", --Server-side and client-side imagemaps
 "dot", "emf", "emfplus", "eps", --Encapsulated PostScript
 "fig", --FIG
 "gd", "gd2", --GD/GD2 formats
 "gif", --GIF
 "gtk", --GTK canvas
 "gv", "ico", --Icon Image File Format
 "imap", "imap_np", "ismap", --erver-side imagemap (deprecated)
 "jpe", "jpeg", "jpg", "metafile", "pdf", --Portable Document Format (PDF)
 ...
 "tk", "vml", "vmlz", --Vector Markup Language (VML)
